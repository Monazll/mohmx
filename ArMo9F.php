...
##@php_apa###
##@F_ppp###
$API_KEY = "توكن"; // التوكن البوت
$Dev = array("296369326", "296369326" ); //ايدي المطور 
flush();
ob_start();
set_time_limit(0);
error_reporting(0);
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت  • √",'url'=>"https://telegram.me/ArMoF"]
              ] 
              ],
        ])
            ]);
